...
const ScoreForm: React.FC<ScoreFormProps> = ({ onSave, incomingTimeLog }) => {
  ...
  const resetScore = (id: string) => {
    switch (id) {
      case SECTION_IDS.L_LC1:
        setL_Lc1(0);
        break;
      case SECTION_IDS.L_LC2:
        setL_Lc2(0);
        break;
      case SECTION_IDS.L_P1:
        setL_P1(0);
        break;
      case SECTION_IDS.L_P2:
        setL_P2(0);
        break;
      case SECTION_IDS.L_LEC1:
        setL_Lec1(0);
        break;
      case SECTION_IDS.L_LEC2:
        setL_Lec2(0);
        break;
      case SECTION_IDS.L_LEC3:
        setL_Lec3(0);
        break;
      case SECTION_IDS.R_BC:
        setR_Bc(0);
        break;
      case SECTION_IDS.R_MAT:
        setR_Mat(0);
        break;
      case SECTION_IDS.R_CR1:
        setR_Cr1(0);
        break;
      case SECTION_IDS.R_CR2:
        setR_Cr2(0);
        break;
      case SECTION_IDS.W_WRIT:
        setW_Writ(0);
        break;
      case SECTION_IDS.T_TRANS:
        setT_Trans(0);
        break;
    }
  };
  ...
  const finalizeSave = () => {
    ...
    const record: PracticeRecord = {
      ...
      inputs: {
        listening: {
          longConversation1: l_lc1,
          longConversation2: l_lc2,
          passage1: l_p1,
          passage2: l_p2,
          lectures1: l_lec1,
          lectures2: l_lec2,
