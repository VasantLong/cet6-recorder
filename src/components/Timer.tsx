    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col h-full">
      ...
      <div className="mb-6">
        ...
        <select
          ...
          className="w-full text-sm border-gray-200 rounded-lg p-2.5 bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
        >
      ...
      <div className="mt-6 pt-4 border-t border-gray-100 text-xs text-gray-400 text-center">
        Select a section above to track time. <br/>Listening sections do not require timing.
      </div>
    </div>
  );
};
