...
import { SECTION_IDS, SCORING_WEIGHTS } from "../types";
  ...
  const data = [...records]
    ...
    .map((r) => {
      ...
      switch (metric) {
        ...
        case "l_long":
          score =
            (inputsL.longConversation1 + inputsL.longConversation2) *
            SCORING_WEIGHTS.listening.longConversation;
          duration = null;
          break;
        case "l_pass":
          score =
            (inputsL.passage1 + inputsL.passage2) *
            SCORING_WEIGHTS.listening.passage;
          duration = null;
          break;
        case "l_lect":
          score =
            (inputsL.lectures1 + inputsL.lectures2 + inputsL.lectures3) *
        ...
        case "r_cr":
          score =
            (inputsR.carefulReading1 + inputsR.carefulReading2) *
            SCORING_WEIGHTS.reading.carefulReading;
          duration =
            (dur[SECTION_IDS.R_CR1] || 0) + (dur[SECTION_IDS.R_CR2] || 0);
          break;
      ...
      return {
        ...
        displayDate: new Date(r.timestamp).toLocaleDateString(undefined, {
          month: "numeric",
          day: "numeric",
        }),
